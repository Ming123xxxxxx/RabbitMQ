package com.example.demo.死信队列.队列达到最大长度.product;

import com.example.demo.死信队列.队列达到最大长度.utils.RabbitMQUtils;
...
public class Task2 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        while(i<10){
                ...
                channel.basicPublish(normal_name,"zhangsan",null,message.getBytes("UTF-8"));
