package com.example.demo.死信队列.消息被拒.work;

import com.example.demo.死信队列.消息被拒.utils.RabbitMQUtils;
...
public class Customer1 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //开启手动应答
        channel.basicConsume(normal_queue,false,(e1,e2)->{
            String s = new String(e2.getBody());
            //设置消息被拒的条件
            if(s.equals("info3")||s.equals("info5")){
                System.out.println(new String(e2.getBody())+"--此消息是被C1拒绝的");
                //basicReject():参数一:消息的DeliveryTag   参数二:是否放回队列中
                channel.basicReject(e2.getEnvelope().getDeliveryTag(),false);
            }else{
